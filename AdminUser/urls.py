...
from AdminUser.views import  AdminCreateAPIView, AdminListAPIView,AdminDetailAPIView,AdminDeleteAPIView,AdminUserDetailAPIView
...
urlpatterns = [
    ...
    path('admin-user-detail/', AdminUserDetailAPIView.as_view(), name='admin-user-detail'),
]